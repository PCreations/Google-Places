...
{
    throw new EasyCurlRequestTypeException('Request failed : <br />
                                            Error number : ' . $executionResult->ErrorNumber . '<br />
                                            Error message : ' . $executionResult->ErrorMessage . '<br />
                                            Error description : ' . $executionResult->ErrorShortDescription . '<br />');
}
